        ...
        <div className={styles.wrapper}>
          ...
          <section className={styles.body}>
            ...
            <p>
              ...
              project, I fell in love with the process of bringing json objects
              to life -- it's satisfyingly beautiful. Even though the project is
              long over, I have been adding new features and building on
              existing code ever since.
            </p>
            <p>
